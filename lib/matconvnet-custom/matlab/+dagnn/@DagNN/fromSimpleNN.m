...
for l = 1:numel(net.layers)
  ...
  switch net.layers{l}.type
    ...
    case {'tukeyloss-heatmap'}
      block = RegLoss('loss', 'tukeyloss-heatmap') ;
      % The loss has two inputs
      inputs{2} = getNewVarName(obj, 'label') ;
    ...
    case {'l2loss-heatmap'}
      block = RegLoss('loss', 'l2loss-heatmap') ;
       % The loss has two inputs
      inputs{2} = getNewVarName(obj, 'label') ;
      
    case {'l2loss-bodyheatmap'}
      block = RegLoss('loss', 'l2loss-bodyheatmap') ;
      % The loss has two inputs
      inputs{2} = getNewVarName(obj, 'label') ;
      
    case {'l2loss-combiheatmap'}
      block = RegLoss('loss', 'l2loss-combiheatmap') ;
      % The loss has two inputs
      inputs{2} = getNewVarName(obj, 'label') ;
